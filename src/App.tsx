...
const FlowContent = () => {
  ...
  const exportarPDF = useCallback(async () => {
    ...
    addDebugLog('Iniciando exportação PDF (v2.0.41 - Precisão Cirúrgica)...');
    setSyncStatus('syncing');
    ...
    styleEl.innerHTML = `
      ...
      .react-flow__node > div { border: 4px solid #000 !important; color: #000 !important; background: #fff !important; }
      .react-flow__edge-path { stroke: #000 !important; stroke-width: 6px !important; stroke-opacity: 1 !important; }
    `;
    ...
    try {
      ...
      addDebugLog('PDF v2.0.41 gerado com sucesso (Precisão Cirúrgica)!');
      setSyncStatus('synced');
    } catch (error) {
