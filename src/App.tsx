...
const FlowContent = () => {
  ...
  const exportarPDF = useCallback(async () => {
    ...
    addDebugLog('Iniciando exportação PDF (v2.0.47 - Precisão Cirúrgica)...');
    setSyncStatus('syncing');
    ...
    styleEl.innerHTML = `
      ...
      .react-flow__edge-path { stroke: #000 !important; stroke-width: 10px !important; stroke-opacity: 1 !important; }
    ...
    try {
      ...
      addDebugLog('PDF v2.0.47 gerado com sucesso (Precisão Cirúrgica)!');
      setSyncStatus('synced');
    } catch (error) {
