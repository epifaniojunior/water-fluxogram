...
const FlowContent = () => {
  ...
  const exportarPDF = useCallback(async () => {
    ...
    addDebugLog('Iniciando exportação PDF Otimizada (v1.9.8)...');
    setSyncStatus('syncing');
    ...
    try {
      ...
      // 2. CAPTURA COM CLONE MANUAL (v1.9.8)
      ...
      // Pequeno delay para garantir que o navegador processe o clone no DOM
      ...
      const dataUrl = await toJpeg(clone, {
        ...
        quality: 0.8,
        pixelRatio: 1, // Mantém o arquivo leve (evita os 40MB)
      ...
      addDebugLog('PDF gerado com sucesso (v1.9.8)!');
      setSyncStatus('synced');
    } catch (error) {
