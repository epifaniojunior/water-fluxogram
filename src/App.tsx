...
const FlowContent = () => {
  ...
  const exportarPDF = useCallback(async () => {
    ...
    try {
      // 1. Forçar um fitView com padding alto para garantir espaço para o título no topo
      // e garantir que o projeto inteiro caiba com folga
      fitView({ duration: 0, padding: 0.7, includeHiddenNodes: true });
      
      // Esperar tempo suficiente para o React Flow processar o reposicionamento (essencial no mobile)
      await new Promise(resolve => setTimeout(resolve, 1000));

      // Ocultar elementos da UI que não devem sair no PDF
      ...
      // Adicionar título temporário bem no topo do container
      ...
      // Forçar estilos de segurança nos labels das arestas
      ...
      // Delay adicional para renderização do título e labels
      await new Promise(resolve => setTimeout(resolve, 500));

      // Captura usando toPng com alta densidade de pixels
