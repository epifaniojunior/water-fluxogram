...
const FlowContent = () => {
  ...
  const exportarPDF = useCallback(async () => {
    ...
    addDebugLog('Iniciando exportação PDF (v2.0.42 - Precisão Cirúrgica)...');
    setSyncStatus('syncing');
    ...
    styleEl.innerHTML = `
      ...
      .react-flow__edge-path { stroke: #000 !important; stroke-width: 12px !important; stroke-opacity: 1 !important; }
      /* Forçar fontes maiores para legibilidade (estilo desktop) */
    ...
    try {
      ...
      addDebugLog('PDF v2.0.42 gerado com sucesso (Precisão Cirúrgica)!');
      setSyncStatus('synced');
    } catch (error) {
