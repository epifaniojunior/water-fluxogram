    ...
    <div style={{ width: '100vw', height: '100vh', display: 'flex', overflow: 'hidden', flexDirection: isMobileView ? 'column' : 'row' }}>
      ...
      <div style={{ flexGrow: 1, display: 'flex', flexDirection: 'column', position: 'relative', overflow: 'hidden' }}>
        <div style={{ 
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%' }}>
                ...
                {isMobileView && (
                  <div style={{ 
                    ...
                    {isLandscape ? 'CONSULTA' : 'Modo Consulta'}
                  </div>
                )}
              </div>
            )}
          ...
          <div style={{ display: 'flex', gap: '12px', alignItems: 'center', flex: isLandscape ? '0 0 auto' : 1, justifyContent: 'flex-end' }}>
            <button 
        ...
        <div style={{ flexGrow: 1, position: 'relative' }}>
          ...
          >
            ...
            <Controls showInteractive={modoEdicao} position={isMobileView ? "bottom-center" : "bottom-left"} />
