...
const FlowContent = () => {
  ...
  const exportarPDF = useCallback(async () => {
    ...
    addDebugLog('Iniciando exportação PDF (v2.0.44 - Precisão Cirúrgica)...');
    setSyncStatus('syncing');
    ...
    styleEl.innerHTML = `
      ...
      .react-flow__edge-path { stroke: #000 !important; stroke-width: 24px !important; stroke-opacity: 1 !important; }
    ...
    try {
      ...
      addDebugLog('PDF v2.0.44 gerado com sucesso (Precisão Cirúrgica)!');
      setSyncStatus('synced');
    } catch (error) {
