...
const FlowContent = () => {
  ...
  const exportarPDF = useCallback(async () => {
    ...
    addDebugLog('Iniciando exportação PDF (v2.0.37 - Deep Force toPng)...');
    setSyncStatus('syncing');
    ...
    try {
      ...
      // 2. CAPTURAR USANDO PNG (Alta qualidade)
      ...
      addDebugLog('PDF v2.0.37 gerado com sucesso!');
      setSyncStatus('synced');
    } catch (error) {
